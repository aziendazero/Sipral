 ...
 * references, apply the {@link com.phi.cs.catalog.adapter.nestedset.query.NestedSetResultTransformer} to the
...
public class NestedSetQueryBuilder {
    ...
    public String getSelectLevelClause() {
        ...
        clause.append("count(").append(NestedSetQueryBuilder.NODE_ALIAS).append(".internalId) as ").append(PROJECTION_LEVEL_ALIAS);
        return clause.toString();
    }
...
//        clause.append(", ").append(NODE_ALIAS).append(".id");
        clause.append(", ").append(NODE_ALIAS).append(".internalId");
        return clause.toString();
    }
    ...
    protected String getEntityName() {
    	return HibernateProxyHelper.getClassWithoutInitializingProxy(startTree).getName();
    }
