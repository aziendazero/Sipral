...
LOG._logToServer = function(msg, logLevel)
{
    ...
    xhr.open('POST', 'resource/rest/logs/error' + cidParam, true);
...
// Return action URL ( append extention, if present )
        getActionUrl : function( ext ) {
            ...
            if(window.location.port == '3000') { //developement localehost:3000 -> cors -> localhost:8080
                actionUrl = 'http://localhost:8080/PHI_CI/home-jsf.seam' ;
                //var actionUrl = 'http://localhost:8080/spisal/home-jsf.seam' ;
                //var actionUrl = 'http://localhost:8080/PHI_KLINIK/home-jsf.seam' ;
            }
