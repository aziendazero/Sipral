...
import com.phi.entities.dataTypes.II4Patient;
...
@Table(name = "patient")
//@Immutable 	// comment this if no patient data encryption is used and remove all @NotAudited for Patient
@Audited		// comment this if patient data encryption is used
@JsonIdentityInfo(generator=JsonProxyGenerator.class, property="proxyString", scope=Patient.class)
public class Patient extends BaseEntity /*Role*/ {

	private static final long serialVersionUID = 7306950979630365567L;
	...
	*/
	...
	@ForeignKey(name="FK_Patient_currentOrgCode")
	@Index(name="IX_Patient_currentOrgCode")
	...
	*/
	...
	@ForeignKey(name="FK_Patient_statusCode")
	@Index(name="IX_Patient_statusCode")
	...
	@ForeignKey(name="FK_Patient_countryOfBirth")
	@Index(name="IX_Patient_countryOfBirth")
	...
	@ForeignKey(name="FK_Patient_language")
	@Index(name="IX_Patient_language")
	...
	@ForeignKey(name="FK_Patient_genderCode")
	@Index(name="IX_Patient_genderCode")
	...
	@Column(name = "note_polizza",length=2500)
	public String getNotePolizza() {
		return notePolizza;
	}

	public void setNotePolizza(String notePolizza) {
		this.notePolizza = notePolizza;
	}
	...
	@ForeignKey(name="FK_Patient_doctor")
	@Index(name="IX_Patient_doctor")
	...
	@ForeignKey(name="FK_Patient_aslApp")
	...
	@ForeignKey(name="FK_Patient_aslAss")
	...
	@ForeignKey(name="FK_Patient_district")	
	...
	@ForeignKey(name="FK_Pat_maritalStatus")
	...
	@ForeignKey(name="FK_Pat_livingArrangmnt")
	@Index(name="IX_Pat_livingArrangmnt") 
	...
	@ForeignKey(name="FK_Pat_educationLevel")
	@Index(name="IX_Pat_educationLevel")
	...
	@ForeignKey(name="FK_pat_relig_affil")
	@Index(name="IX_pat_relig_affil")
	...
	@ForeignKey(name = "FK_Pat_citizen")
	@Index(name="IX_Pat_citizen")
	...
	@OneToMany(targetEntity=II4Patient.class ,fetch=FetchType.LAZY, cascade=CascadeType.ALL)
	@JoinColumn(name="patient_id")
	@ForeignKey(name="FK_Patient_id")
	@Index(name="IX_Patient_id")
	@AuditJoinTable(name="z_patient_id_jt")
	public Set<II> getId() {
		return id;
	}
