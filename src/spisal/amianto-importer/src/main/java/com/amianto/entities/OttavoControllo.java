...
/**
 * The persistent class for the ottavo_controllo database table.
 * 
 */
@Entity
@Table(name="ottavo_controllo")
@AttributeOverrides({
...
public class OttavoControllo extends VisitaGenerica implements Serializable {
	private static final long serialVersionUID = 1L;

	public OttavoControllo() {
	}
