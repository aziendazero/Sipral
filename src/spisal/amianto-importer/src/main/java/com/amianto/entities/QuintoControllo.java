...
/**
 * The persistent class for the quinto_controllo database table.
 * 
 */
@Entity
@Table(name="quinto_controllo")
@AttributeOverrides({
...
public class QuintoControllo extends VisitaGenerica implements Serializable {
	private static final long serialVersionUID = 1L;

	public QuintoControllo() {
	}
