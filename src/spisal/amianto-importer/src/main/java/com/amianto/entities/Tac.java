...
/**
 * The persistent class for the tac database table.
 * 
 */
@Entity
@Table(name="tac")
...
public class Tac implements Serializable {
	...
	private TipologiaRadiodiagnostica tipologia;
	...
	public TipologiaRadiodiagnostica getTipologia() {
	    return tipologia;
	}


	public void setTipologia(TipologiaRadiodiagnostica param) {
