...
/**
 * The persistent class for the PREPARATICANCEROGENI database table.
 * 
 */
@Entity
@NamedQuery(name="Preparaticancerogeni.findAll", query="SELECT p FROM Preparaticancerogeni p")
public class Preparaticancerogeni implements Serializable {
	private static final long serialVersionUID = 1L;
	private long idpreparaticancerogeni;
	...
	public Preparaticancerogeni() {
	}


	@Id
	public long getIdpreparaticancerogeni() {
		return this.idpreparaticancerogeni;
	}

	public void setIdpreparaticancerogeni(long idpreparaticancerogeni) {
		this.idpreparaticancerogeni = idpreparaticancerogeni;
	}
