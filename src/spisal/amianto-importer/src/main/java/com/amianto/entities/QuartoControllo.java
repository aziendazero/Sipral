...
/**
 * The persistent class for the quarto_controllo database table.
 * 
 */
@Entity
@Table(name="quarto_controllo")
@AttributeOverrides({
...
public class QuartoControllo extends VisitaGenerica implements Serializable {
	private static final long serialVersionUID = 1L;

	public QuartoControllo() {
	}
