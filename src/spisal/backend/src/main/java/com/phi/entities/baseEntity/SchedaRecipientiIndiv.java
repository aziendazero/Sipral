...
@Table(name = "scheda_recipienti_indiv")
@Inheritance(strategy = InheritanceType.TABLE_PER_CLASS)
@Audited
public class SchedaRecipientiIndiv extends BaseEntity {

	private static final long serialVersionUID = 908800321L;
	...
	*/
	...
	@ForeignKey(name="FK_SchdRcipintiIndiv_mpPrss")
	//@Index(name="IX_SchdRcipintiIndiv_mpPrss")
	...
	*/
	...
	@Override
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "SchedaRecipientiIndiv_sequence")
	@SequenceGenerator(name = "SchedaRecipientiIndiv_sequence", sequenceName = "SchedaRecipientiIndiv_sequence")
