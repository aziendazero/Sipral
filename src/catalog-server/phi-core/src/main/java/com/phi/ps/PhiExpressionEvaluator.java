 ...
 *
 *
 * PHI CUSTOMIZATION: throw exception
 */
public class PhiExpressionEvaluator  extends ExpressionEvaluator
{
   
    private static LogProvider log = Logging.getLogProvider(PhiExpressionEvaluator.class);
    ...
    private static ELContext createELContext(VariableResolver resolver, FunctionMapper functionMapper)
    {
        ...
        composite.add( new PhiJbpmELResolver(resolver) );
