...
/**
 * The persistent class for the ANAMNESIFISIOLOGICA database table.
 * 
 */
@Entity
@Table(name="anamnesifisiologica")
public class Anamnesifisiologica implements Serializable {
