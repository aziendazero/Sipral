	...
	$.widget("awnry.pickList",
	{
		...
		_buildSourceList: function()
		{
			...
			if (self.element.prop('disabled')) {
				self.sourceList.addClass('disabled');
			} else {
				self.sourceList.delegate("li", "click", { pickList: self }, self._changeHandler);
		...
		_buildTargetList: function()
		{
			...
			if (self.element.prop('disabled')) {
				self.targetList.addClass('disabled');
			} else {
				self.targetList.delegate("li", "click", { pickList: self }, self._changeHandler);
		...
		_buildControls: function()
		{
			...
			var isDisabled = self.element.prop('disabled');
			self.addAllButton = $("<button type='button'/>").click({pickList: self}, self._addAllHandler).html(self.options.addAllLabel).addClass(self.options.addAllClass).prop('disabled',isDisabled);
			self.addButton = $("<button type='button'/>").click({pickList: self}, self._addHandler).html(self.options.addLabel).addClass(self.options.addClass).prop('disabled',isDisabled);
			self.removeButton = $("<button type='button'/>").click({pickList: self}, self._removeHandler).html(self.options.removeLabel).addClass(self.options.removeClass).prop('disabled',isDisabled);
			self.removeAllButton = $("<button type='button'/>").click({pickList: self}, self._removeAllHandler).html(self.options.removeAllLabel).addClass(self.options.removeAllClass).prop('disabled',isDisabled);
